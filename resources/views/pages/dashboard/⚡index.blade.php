...
<div class="flex w-full flex-1 flex-col gap-6 px-2 py-4 lg:px-4">
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <a href="{{ route('lottery.index') }}" wire:navigate
            class="group flex flex-col items-center gap-3 rounded-xl border border-zinc-200 bg-white p-6 shadow-xs transition hover:shadow-md dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-zinc-600">
            <div class="flex size-12 items-center justify-center rounded-lg bg-violet-50 dark:bg-violet-900/30">
                <flux:icon.ticket variant="solid" class="size-6 text-violet-500" />
            </div>
            <flux:heading size="sm" class="text-center">{{ __('Lottery') }}</flux:heading>
        </a>
    </div>
</div>
